...
2. Forge `page_drawing_workspace` 本轮改为以“图纸总览”为默认入口，首屏对齐 RISEMAP 的标题、说明、七个指标、快捷入口和三块待办/风险区域；该阶段仅记录了 ObjectStack Console 外壳差异，当前仍须按同视口截图、差异图、像素差比例与几何偏差门禁补做像素级验收，旧阶段结论不能据此视为当前视觉通过。
