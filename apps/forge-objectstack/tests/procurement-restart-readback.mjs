...
assert.deepEqual(
  ...
  { order_id: order, order_line_id: orderLine, sku_id: sku, status: 'pending_arrival', planned_quantity: 2, arrived_quantity: 0 },
);
...
console.log('PASS procurement order, line and arrival notice persist after restart');
