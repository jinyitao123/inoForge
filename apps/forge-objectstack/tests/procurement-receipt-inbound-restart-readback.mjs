...
assert.deepEqual({ source_object: ledger.source_object, source_id: ledger.source_id, movement_type: ledger.movement_type,
  ...
  balance_matches_ledger_after: balance.on_hand_quantity === ledger.after_on_hand },
{ source_object: 'forge_purchase_inbound', source_id: report.ids.inbound, movement_type: 'purchase_inbound',
  quantity: 1, amount: 6800, before_after_delta: 1, balance_matches_ledger_after: true });
...
report.restartVerification = {
  ...
  recordsRead: 7, assertion: 'receipt, partial inspection, accepted-quantity inbound, inventory balance delta, source-linked ledger and purchase rollups survived a full stop/start',
};
