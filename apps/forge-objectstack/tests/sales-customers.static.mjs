...
for(const scope of ['participated','subordinate_owned','subordinate_participated'])if(!page.includes(`setScopeInfo`)||!page.includes(scope))throw new Error(`scope tab ${scope} must open an explanation dialog`);
