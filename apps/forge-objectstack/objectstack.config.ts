      ...
      },
      {
        id: 'production', label: '生产', icon: 'factory', navigation: [
          ...
          group('subcontract_management', '委外管理', [
            ...
            page('subcontract_reconciliation', '委外对账', 'page_subcontract_reconciliation_recovery_status', 'file-check-2'),
            page('subcontract_reconciliation_report', '委外对账单', 'page_subcontract_reconciliation_recovery_status', 'file-check-2'),
