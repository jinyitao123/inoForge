...
export const SupplierPrepaymentRequestRefund = defineAction({
  ...
  onSuccess: { navigate: '/_console/apps/forge/page/page_supplier_refund?refund=${result.id}' },
  body: { language: 'js', capabilities: ['api.read', 'api.write'], source: `
