...
export const ProjectSettle = defineAction({
  ...
  description: '在交付验收、全额开票和全额回款后固化项目收入、生产材料成本和毛利快照。', successMessage: '项目已结算',
