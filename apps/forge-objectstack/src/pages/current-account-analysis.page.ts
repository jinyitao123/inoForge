...
function App(){
 ...
 const icon=<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 3h12l4 4v14H4z"/><path d="M16 3v5h5M8 12h8M8 16h8M8 8h3"/></svg>,goLedger=()=>navigate('/apps/com.inoforge.forge.finance/page_receivables_payables');
