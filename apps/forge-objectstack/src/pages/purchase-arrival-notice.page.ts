...
function App(){
 ...
 function toggle(id){setSelected(v=>v.includes(id)?[]:[id])}function register(id){navigate('/apps/com.inoforge.forge.supply-chain/page_purchase_arrival_workspace?notice='+encodeURIComponent(id))}
