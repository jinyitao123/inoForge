...
import { master, text, code, reference, choice, materialPropertyLabels, materialSourceTypeLabels, owner, remarks, status, money } from '../model.js';
...
export const Material = master('forge_material', '物料管理', 'package', {
  ...
  property: choice('物料属性', materialPropertyLabels, '原材料'),
  source_type: choice('来源类型', materialSourceTypeLabels, '采购'), status: status(),
